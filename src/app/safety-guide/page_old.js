      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg mb-8">
          ...
          <div className="p-8">
            ...
            {activeTab === 'weather' && (
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6">天候別注意点</h2>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        <h4 className="font-semibold text-blue-700 mb-2">風速の目安</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-blue-700 mb-2">危険症状</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 立っているのが困難</li>
                          <li>• 波しぶきが激しい</li>
                          <li>• 釣り具が飛ばされる</li>
                      ...
                      <div>
                        <h4 className="font-semibold text-blue-700 mb-2">対策</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 風裏の場所を選ぶ</li>
                          <li>• 低い姿勢を保つ</li>
                          <li>• 早めの撤退判断</li>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-semibold text-gray-700 mb-2">⚡ 雷の危険サイン</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 雷鳴が聞こえる</li>
                          <li>• 髪の毛が逆立つ</li>
                          <li>• 金属製品がビリビリする</li>
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-700 mb-2">🏃 緊急対応</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 即座に釣りを中止</li>
                          <li>• 竿を地面に置く</li>
                          <li>• 車内や建物に避難</li>
                  ...
                  <div className="bg-purple-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-semibold text-purple-700 mb-2">🌸 春・秋</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 低気圧による急変</li>
                          <li>• 寒暖差への対応</li>
                          <li>• 台風シーズン注意</li>
                      ...
                      <div>
                        <h4 className="font-semibold text-purple-700 mb-2">☀️ 夏・冬</h4>
                        <ul className="space-y-1 text-sm text-gray-700">
                          <li>• 夏：熱中症・突然の雷雨</li>
                          <li>• 冬：低体温症・高波</li>
                          <li>• 水分補給・防寒対策</li>
            ...
            {activeTab === 'emergency' && (
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6">緊急時対応</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={index} className={`relative group hover:scale-105 transition-all duration-300`}>
                <div className={`p-6 bg-gradient-to-br ${item.bgColor} rounded-2xl shadow-md hover:shadow-lg border border-white/50`}>
                  {/* チェックボックス風のデザイン */}
                  <div className="flex items-start mb-4">
                    <div className={`w-8 h-8 bg-gradient-to-br ${item.color} text-white rounded-lg flex items-center justify-center text-sm font-bold shadow-md mr-3 flex-shrink-0`}>
                      {item.number}
                    </div>
